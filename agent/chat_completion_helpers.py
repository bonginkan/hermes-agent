...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    """Legacy compatibility shim for removed iteration caps.

    The autonomous conversation loop no longer stops on iteration counts and no
    longer injects a synthetic summarization request.  If an old caller still
    reaches this shim, return a neutral diagnostic instead of making another
    model call.
    """
    return "Iteration limits are disabled; continue the autonomous run instead of summarizing."
